...
import { Clouds, Cloud, CameraControls, StatsGl } from "@react-three/drei"
  ...
  return (
    <>
      ...
      <group ref={ref}>
        ...
        <Cloud ref={cloud0} bounds={[x, y, z]} color={color} texture={"https://s.vrgmetri.com/gb-web/fruit-salad/test/cloud.png"} />
        ...
        {/* <Cloud growth={100} color="#ffccdd" opacity={1.25} seed={0.3} bounds={200} volume={200} /> */}
        {/* </Clouds> */}
      </group>
    </>
  )
